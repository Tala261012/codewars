...
//? .toJSON
// все объекты типа Date имеют встроенный метод toJSON,
// который возвращает строку с датой.

/*
? .toString()
- local time + дата
? .toUTDString()
- зона по Гринвичу + дата
? .toTimeString()
- local time без даты
? .toDateString()
- только дата без времени
Эта функции ВОЗВРАЩАЮТ СТРОКУ с датой/временем в понятном для человека виде
*/
